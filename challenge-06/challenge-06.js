...
desafio.
*/
var teams = [ 'Pain', 'INTZ', 'Flamengo', 'Kabum', 'Brave' ];
...
var convertToHex = function(color){
    switch( color ){
        ...
        case 'white':
            ...
            break;
        case 'yellow':
            return "O hexadecimal para a cor "+ color + " é #F5F600.";
            break;
        case 'green':
            return "O hexadecimal para a cor "+ color + " é #22F600.";
            break;
        default:
